    ...
    <>
      <nav>
        ...
        <div className="options">
          <ul>
            <li>options</li>
            <li>options<i className="fa fa-angle-down" aria-hidden="true"></i>
        ...
        <div className="cart-icon" datacount={0} onClick={openCart}>
          <svg xmlns="http://www.w3.org/2000/svg" className="icon icon-tabler icon-tabler-basket" width="28" height="28" viewBox="0 0 24 24" strokeWidth="1.5" stroke="#000000" fill="none" strokeLinecap="round" strokeLinejoin="round">
